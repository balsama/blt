  ...
  protected function executeBltUpdate($version) {
    ...
    if ($this->isInitialInstall()) {
      ...
      if ($this->isNewProject()) {
        ...
        $success = $this->executeCommand($this->getVendorPath() . '/phing/phing/bin/phing -f ' . $this->getVendorPath() . '/acquia/blt/phing/build.xml create-project', [], TRUE);
      }
      else {
        $success = $this->executeCommand($this->getVendorPath() . '/phing/phing/bin/phing -f ' . $this->getVendorPath() . '/acquia/blt/phing/build.xml add-to-project', [], TRUE);
      }
    }
